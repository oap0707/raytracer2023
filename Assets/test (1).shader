...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		if (index == 0) { mat.make(vec3(0.8, 0.3, 0.3), false); }
		if (index == 1) { mat.make(vec3(0.8, 0.8, 0.0), false); }
		if (index == 2) { mat.make(vec3(0.8, 0.6, 0.2), true); }
		if (index == 3) { mat.make(vec3(0.8, 0.8, 0.8), true); }
	}
	...
	bool hit(ray r, float tmin, float tmax, out hit_record rec)
	{
		...
		{
			getsphere(i, sph);
			/*if (sph.hit(r, tmin, closest_so_far, temp_rec))
			{
				hit_anything = true;
