...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	class material
	{
		...
		void make(int mt, vec3 a, float f, float ri)
		{
			mat_type = mt;
			albedo = a;
			fuzz = f;
	...
	{
		if (index == 0) { mat.make(1, vec3(0.1, 0.2, 0.5), 0.0, 0.0); }
		if (index == 1) { mat.make(1, vec3(0.8, 0.8, 0.0), 0.0, 0.0); }
		if (index == 2) { mat.make(0, vec3(0.8, 0.6, 0.2), 0.0, 0.0); }
		if (index == 3) { mat.make(2, vec3(0,0,0), 0.0, 1.5); }
	}
	...
	void getsphere(int i, out sphere sph)
	{
		...
		{ 
			...
			getMat(1, mat);
			//sph.mat = mat;
			sph.make(vec3(0, -100.5, -1), 100, mat);
		}
		if (i == 2) 
		{ 
